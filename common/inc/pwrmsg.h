...
enum OperationType {
    ...
    PROC_GET_WATT_ARRTS,
    PROC_SET_WATT_ARRTS,
    PROC_GET_WATT_PROCS = 605,
    PROC_ADD_WATT_PROCS,
    PROC_DEL_WATT_PROCS,
    PROC_GET_SMART_GRID_STATE,
    PROC_SET_SMART_GRID_STATE,
    PROC_GET_SMART_GRID_PROCS = 610,
    PROC_SET_SMART_GRID_PROCS_LEVEL,
    PROC_GET_SMART_GRID_GOV,
    PROC_SET_SMART_GRID_GOV,
    PROC_GET_SERVICE_STATE,
    PROC_SET_SERVICE_STATE = 615,
    PROC_SET_WATT_FIRST_DOMAIN,
    HBM_GET_SYS_STATE = 700,
    HBM_SET_ALL_POWER_STATE,
};
enum DataFormat {
    FMT_BIN = 0,
};
