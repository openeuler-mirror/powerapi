...
enum PWR_RtnCode {
    ...
    PWR_ERR_SMART_GRID_NOT_SURPPORTED = 105,
    PWR_ERR_SMART_GRID_GOV_DISABLED,
    PWR_ERR_SERVICE_UNABLE,
    PWR_ERR_SERVICE_NOT_EXIST,
    PWR_ERR_WATT_NOT_SUPPORT_SET_DOMAIN,
    PWR_ERR_WATT_NEED_DISABLE_TO_SET_DOMAIN = 110,
    ...
    PWR_ERR_CONTROL_AUTH_NO_PERMISSION = 405,
    PWR_ERR_NOT_SUPPORT_TASK_TYPE,
    PWR_ERR_NO_PROCS_BY_KEYWORD,
    ...
    PWR_ERR_HBM_SET_POWER_STATE_FAILED = 601,
    PWR_ERR_HBM_OFFLINE_MEMORY_FAILED,
    PWR_ERR_HBM_REVERT_MEMORY_FAILED,
    PWR_ERR_HBM_FLUSH_CACHE_FAILED,
};
#endif