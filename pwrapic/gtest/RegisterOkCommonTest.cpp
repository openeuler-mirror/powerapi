 ...
 */
TEST_F(RegisterOkTestCommon, PWR_SetMetaDataCallback_Test_003)
{
    EXPECT_EQ(SUCCESS,
        PWR_SetMetaDataCallback([](const PWR_COM_CallbackData *callbackData) {
            ...
            EXPECT_NE(std::string::npos, str.find("2022"));
 ...
 */
TEST_F(RegisterOkTestCommon, PWR_RequestControlAuth_Test_002)
{
